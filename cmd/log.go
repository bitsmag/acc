...
var logCmd = &cobra.Command{
	Use:   "log",
	Short: "Prints out all bookings                           FLAGS: -o --order ['year' | 'category']; -d --date [(DD).(MM).YYYY]; c --category <category>",
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		logOutput := useroutput.CreateLog(filteredEntries, logOrder)
		useroutput.PrintPrintablelns(logOutput...)
		return nil
	},
}
